...
public class SecurityConfig {
	...
	public UserDetailsService userDetailsService() {
		UserDetails userDetails = User.withDefaultPasswordEncoder() //using a default password encoder
				.username("user")
				.password("password")
				.roles("USER")
				.build();
    ...
    //method to generate RSA KeyPair
